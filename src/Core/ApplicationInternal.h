...
inline void ApplyProfessionalImGuiStyle()
{
    ...
    colors[ImGuiCol_WindowBg] = ImVec4(0.07f, 0.09f, 0.11f, 0.97f);
    colors[ImGuiCol_ChildBg] = ImVec4(0.10f, 0.13f, 0.16f, 0.92f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.10f, 0.13f, 0.98f);
    colors[ImGuiCol_Border] = ImVec4(0.23f, 0.29f, 0.34f, 0.88f);
    colors[ImGuiCol_FrameBg] = ImVec4(0.13f, 0.17f, 0.21f, 1.0f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.19f, 0.25f, 0.30f, 1.0f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.23f, 0.31f, 0.37f, 1.0f);
    colors[ImGuiCol_TitleBg] = ImVec4(0.06f, 0.08f, 0.10f, 1.0f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.09f, 0.12f, 0.15f, 1.0f);
    colors[ImGuiCol_MenuBarBg] = ImVec4(0.07f, 0.10f, 0.12f, 1.0f);
    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.07f, 0.09f, 0.11f, 1.0f);
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(0.36f, 0.78f, 0.88f, 1.0f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.33f, 0.62f, 0.74f, 1.0f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.45f, 0.78f, 0.88f, 1.0f);
    colors[ImGuiCol_Button] = ImVec4(0.14f, 0.20f, 0.24f, 1.0f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.20f, 0.30f, 0.35f, 1.0f);
    colors[ImGuiCol_ButtonActive] = ImVec4(0.28f, 0.42f, 0.48f, 1.0f);
    colors[ImGuiCol_Header] = ImVec4(0.14f, 0.22f, 0.26f, 1.0f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.20f, 0.31f, 0.36f, 1.0f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.27f, 0.41f, 0.47f, 1.0f);
